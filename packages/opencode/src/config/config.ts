...
export namespace Config {
  ...
  function systemManagedConfigDir(): string {
    switch (process.platform) {
      case "darwin":
        return "/Library/Application Support/lightcode"
      case "win32":
        return path.join(process.env.ProgramData || "C:\\ProgramData", "lightcode")
      default:
        return "/etc/lightcode"
    }
  }
  ...
  const MANAGED_PLIST_DOMAIN = "ai.lightcode.managed"
    ...
    .object({
      ...
      experimental: z
        .object({
          ...
          deferred_tools: z.boolean().optional().describe("Enable deferred tool loading to reduce context usage"),
          openTelemetry: z
            .boolean()
            .optional()
