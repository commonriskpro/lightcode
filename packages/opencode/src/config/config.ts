          ...
          tool_router: z
            .object({
              ...
              intent_max_intents: z
                ...
                .optional()
                .default(3)
                .describe("Max distinct work intents to merge when within intent_merge_margin."),
              intent_conversation_gap: z
                .number()
                .min(0)
                .max(0.3)
                .optional()
