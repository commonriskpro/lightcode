...
export namespace Flag {
  const OPENCODE_ENABLE_EXTERNAL_SKILLS = truthy("OPENCODE_ENABLE_EXTERNAL_SKILLS")
  ...
  export const OPENCODE_DISABLE_EXTERNAL_SKILLS =
    ...
    !OPENCODE_ENABLE_EXTERNAL_SKILLS
  ...
  export const OPENCODE_EXPERIMENTAL_DEFERRED_TOOLS =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_DEFERRED_TOOLS")
  export const OPENCODE_DEFERRED_TOOLS_THRESHOLD = number("OPENCODE_DEFERRED_TOOLS_THRESHOLD") ?? 15
  export const OPENCODE_EXPERIMENTAL_AUTODREAM = OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_AUTODREAM")
  export const OPENCODE_EXPERIMENTAL_TGE = OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_TGE")
