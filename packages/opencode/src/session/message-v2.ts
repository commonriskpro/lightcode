...
export namespace MessageV2 {
  ...
  export const User = Base.extend({
    ...
    /** Count of offline router fallback expansions already used for this user turn (same logical user message). */
    toolRouterFallbackExpansionsUsed: z.number().int().min(0).optional(),
