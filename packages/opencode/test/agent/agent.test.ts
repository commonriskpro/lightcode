  ...
  test("sdd-explore agent has correct properties", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(evalPerm(sddExplore, "edit")).toBe("deny")
        expect(evalPerm(sddExplore, "write")).toBe("deny")
  ...
  test("sdd-spec agent has correct properties", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(sddSpec?.description).toContain("Write specifications")
        expect(evalPerm(sddSpec, "edit")).toBe("deny")
        expect(evalPerm(sddSpec, "write")).toBe("deny")
  ...
  test("sdd-apply agent has correct properties", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(sddApply?.description).toContain("Implement tasks")
  ...
  test("sdd-verify agent has correct properties", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(sddVerify?.description).toContain("Validate that implementation")
        expect(evalPerm(sddVerify, "edit")).toBe("deny")
        expect(evalPerm(sddVerify, "write")).toBe("deny")
